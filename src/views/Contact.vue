<template>
	<div class="contact content">
		...
		<div class="buttons">
			...
			<a class="button is-primary is-instragram" href="https://www.instagram.com/julio.motol/" target="_blank" rel="noreferrer noopenner">
                <span class="icon"><i class="fab fa-instagram"></i></span>
                <span>Instagram</span>
            </a>
			<a class="button is-primary is-github" href="https://github.com/juliomotol" target="_blank" rel="noreferrer noopenner">
                <span class="icon"><i class="fab fa-github-square"></i></span>
                <span>GitHub</span>
            </a>
			<a class="button is-primary" href="https://stackoverflow.com/users/4672917/julio-motol" target="_blank" rel="noreferrer noopenner">
        ...
        <ValidationObserver tag="form" class="columns is-multiline is-variable is-2" @submit.prevent="sendMessage" ref="inquiryForm">
            ...
            <div class="column is-full">
                ...
                <p>For further inquiries, email them to <a href="mailto:julio.motol89@gmail.com" target="_blank" rel="noreferrer noopenner">julio.motol89@gmail.com</a>.</p>
            </div>
        </ValidationObserver>
